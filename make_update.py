...
Usage:
    python make_update.py --source setup/build/app \
        --base-url https://downloads.example.com/xtpos
    python make_update.py --source "C:/Program Files/XTPOS" --version 1.1.1 \
...
def main():
    ...
    ap.add_argument("--base-url", default=os.getenv("UPDATE_BASE_URL", ""),
                    help="Public base URL where the zip will be hosted. The "
                         "manifest 'url' becomes <base-url>/XTPOS-<version>.zip.")
